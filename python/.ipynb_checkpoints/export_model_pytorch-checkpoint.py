...
def main(args):
    ...
    def write_policy_head(name,policyhead):
        ...
        if version <= 11:
            ...
            write_matmul(name+".linear_pass2", torch.stack((policyhead.linear_pass2.weight[0], policyhead.linear_pass2.weight[1], policyhead.linear_pass2.weight[5], policyhead.linear_pass2.weight[6]), dim=0))
            assert policyhead.linear_pass2.bias is None
